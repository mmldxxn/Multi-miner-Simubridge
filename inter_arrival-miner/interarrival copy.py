...
def find_best_fit_distribution(observed_values, N=None, remove_outliers=False) -> Tuple[str, Dict[str, Any]]:
    if remove_outliers:
...
def find_inter_arrival_distribution(log) -> Tuple[str, Dict[str, Any]]:
    inter_arrival_times = compute_inter_arrival_times(log)
    return find_best_fit_distribution(inter_arrival_times)[:2]
